...
class Handle_User_Input:
    def __init__(self):
        ...
        rowlabel = tkinter.Label(self._input_window, text = "Number of Rows", font = ('Helvetica', 12)).grid(row=0)
        columnlabel = tkinter.Label(self._input_window, text = "Number of Columns", font = ('Helvetica', 12)).grid(row=1)
        firstplayerlabel = tkinter.Label(self._input_window, text = "First Player", font = ('Helvetica', 12)).grid(row=2)
        topleftdisclabel = tkinter.Label(self._input_window, text = "Top Left Disc in Center", font = ('Helvetica', 12)).grid(row=3)
        howtowinlabel = tkinter.Label(self._input_window, text = "How to Win (> or <)", font = ('Helvetica', 12)).grid(row=4)
